        ...
        submenu: [
          {
            ...
            click() {
              ...
              if (ethereumNode.isEth) {
                ...
                if (process.platform === 'darwin') {
                  userPath += '/Library/touristcoin/keystore';
                }
                ...
                if (
                  ...
                  userPath += '/.touristcoin/keystore';
                }

                if (process.platform === 'win32') {
                  userPath = `${Settings.appDataPath}\\Ethereum\\social\\keystore`;
                }
              }
  ...
  helpMenu.push(
    {
      ...
      click() {
        shell.openExternal('https://github.com/touristcoin/mist/wiki');
      }
    },
    {
      label: i18n.t('mist.applicationMenu.help.gitter'),
      click() {
        shell.openExternal('https://gitter.im/touristcoin/mist');
      }
    },
    {
      label: i18n.t('mist.applicationMenu.help.reportBug'),
      click() {
        shell.openExternal('https://github.com/touristcoin/mist/issues');
      }
    }
  );
