      ...
      if (type === 'ethersale') {
        ...
        if (ethereumNode.isEth) {
          ...
          if (process.platform === 'darwin')
            keystorePath += '/Library/touristcoin/keystore';
          ...
          if (
            ...
            keystorePath += '/.touristcoin/keystore';

          if (process.platform === 'win32')
            keystorePath = `${Settings.appDataPath}\\Ethereum\\social\\keystore`;
        }
...
ipc.on('mistAPI_requestAccount', e => {
  if (global.mode === 'wallet') {
    ...
    if (e.sender.history[0] === 'https://dapp.touristcoin.net/') {
      createAccountPopup(e);
    } else {
