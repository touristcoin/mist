...
The Tourist Coin wallet, which allows you to create simple and multisig wallets to manage your ether.
...
On OSX its `~/Library/touristcoin/geth.ipc` on linux `~/.touristcoin/geth.ipc` and on windows it uses a named pipe, which doesn't need to be renamed.

Example:

    $ geth --datadir /my/chain/ --networkid 23 --ipcpath ~/Library/touristcoin/geth.ipc
...
* Mac: ~/Library/touristcoin
* Windows: %APPDATA%\Roaming\Ethereum\social
* Linux: ~/.touristcoin

## Issues

If you find issues or have suggestion, please report them at
https://github.com/touristcoin/meteor-dapp-wallet/issues

## Repository

The wallet code can be found at
https://github.com/touristcoin/meteor-dapp-wallet

And the binary application code, which wraps the wallet app can be found at
https://github.com/touristcoin/mist/tree/wallet

## Bundling the wallet

To bundle the binaries yourself follow the instructions on the mist#wallet readme
https://github.com/touristcoin/mist/tree/wallet#deployment
